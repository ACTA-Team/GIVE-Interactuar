...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <ClientCredentialsPage
      ...
      empresario={{
        program: (empresario as EmpresarioRow & { program?: string }).program ?? null,
        ...
        municipality: (empresario as EmpresarioRow & { municipality?: string })
          .municipality ?? null,
        sector: (empresario as EmpresarioRow).sector ?? null,
        salesPrevYearCop: (empresario as { sales_prev_year_cop?: number | null })
          .sales_prev_year_cop ?? null,
        salesCop: (empresario as { sales_cop?: number | null }).sales_cop ?? null,
        growthPct: (empresario as { growth_pct?: number | null }).growth_pct ?? null,
        ...
        cohortYear: (empresario as { cohort_year?: number | null }).cohort_year ?? null,
        activeCredit: (empresario as EmpresarioRow & { active_credit?: string })
          .active_credit ?? null,
        education: (empresario as { education?: string }).education ?? null,
        strata: (empresario as { strata?: number | null }).strata ?? null,
        residenceZone: (empresario as { residence_zone?: string }).residence_zone ?? null,
        legalEntity: (empresario as { legal_entity?: string }).legal_entity ?? null,
        companySize: (empresario as { company_size?: string }).company_size ?? null,
        age: (empresario as { age?: number | null }).age ?? null,
        ageRange: (empresario as { age_range?: string }).age_range ?? null,
        creditRequested: (empresario as { credit_requested?: string })
          .credit_requested ?? '',
